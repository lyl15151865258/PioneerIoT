...
public class ChooseRowsPerPageDialog extends Dialog {

    private Context context;
    private OnDialogClickListener dialogClickListener;

    public ChooseRowsPerPageDialog(Context context) {
        super(context);
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.dialog_choose_rows_per_page, null);
        setContentView(view);
        initWindow();
